// src/components/legal/ManifestoContent.tsx
  ...
  return (
    <article className="max-w-3xl mx-auto">
      ...
      <section className="space-y-4 text-[15px] leading-7 text-neutral-800">
        ...
        <p>
          Burada, dilediğiniz kitap kulübüne üye olabilir, <strong>Book Buddy</strong>&rsquo;ler edinebilir,
          onlarla mesajlaşabilirsiniz. İsterseniz kendi profil sayfanızı oluşturabilir; kitaplar, filmler, resimler,
      ...
      {/* <section className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-neutral-200/80 bg-white p-4">
          <h3 className="text-sm font-semibold mb-2">Ne yapabilirsin?</h3>
          <ul className="list-disc pl-5 space-y-1 text-[15px] text-neutral-800">
            <li>Dilediğin <strong>kitap kulübüne</strong> üye ol</li>
            <li><strong>Book Buddy</strong>&rsquo;ler edin, onlarla mesajlaş</li>
      ...
      <blockquote className="mt-6 rounded-2xl border border-neutral-200 bg-neutral-50 p-5 text-[15px] leading-7 text-neutral-800">
