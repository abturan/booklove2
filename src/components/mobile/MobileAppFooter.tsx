    ...
    <>
      <nav className="fixed inset-x-0 bottom-0 z-50 bg-white/95 backdrop-blur border-t">
        <div className="grid grid-cols-7 items-center px-2 py-2 text-primary">
          <Link href="/?tab=clubs" className="grid place-content-center h-12">
            <IClubs />
          </Link>
          <Link href="/friends" className="relative grid place-content-center h-12">
            <IBuddy />
            <NotificationBadge placement="absolute -top-1 -right-1" />
          </Link>
          <Link href="/?tab=bookie" className="grid place-content-center h-12">
            <IBookie />
          </Link>
          ...
          <Link href="/messages" className="grid place-content-center h-12">
            <IMessages />
          </Link>
          <Link href="/clubs/create" className="grid place-content-center h-12">
            <ICreateClub />
          </Link>
          <button
            type="button"
        ...
        <div className="fixed inset-0 z-[60]">
          ...
          <div className="absolute inset-x-4 bottom-4 rounded-2xl bg-white shadow-xl p-2">
            <div className="grid grid-cols-4 gap-2 text-sm">
              <Link href={profileHref} className="flex flex-col items-center p-3 rounded-xl hover:bg-gray-50">
              ...
              <Link href="/subscriptions" className="flex flex-col items-center p-3 rounded-xl hover:bg-gray-50">
              ...
              <Link href="/profile/settings" className="flex flex-col items-center p-3 rounded-xl hover:bg-gray-50">
