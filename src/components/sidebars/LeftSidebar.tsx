...
//   const showProfileOnly = pathname?.startsWith('/profile/settings') ?? false
...
//       {showProfileOnly && <PublicVisibilityCard username={me?.username ?? null} />}

//       {showProfileOnly && <ShortcutCard />}
