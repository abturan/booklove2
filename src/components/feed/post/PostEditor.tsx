...
export default function PostEditor({ text, setText, images, onRemove, fileRef, onPick, onSave, onCancel }: { text: string; setText: (v: string)=>void; images: { url: string }[]; onRemove: (i:number)=>void; fileRef: React.RefObject<HTMLInputElement>; onPick: (f: FileList|null)=>void; onSave: ()=>void; onCancel: ()=>void }) {
  return (
    <div className="mt-2 space-y-3">
      ...
      <div>
        ...
        <input ref={fileRef} type="file" accept="image/png,image/jpeg" multiple className="hidden" onChange={(e)=>onPick(e.target.files)} />
        <div className="mt-2">
